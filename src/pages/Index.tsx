...
const OfficersIconGroup = () => (
  <div className="relative w-8 h-8">
    <img
      src={officerLogo}
      alt="Officer"
      className="absolute left-0 top-0 pt-3 sm:pt-0 sm:w-9 sm:h-9 rounded-full object-cover"
    />
    <img
      src={officerLogo}
      alt="Officer"
      className="absolute left-1 sm:left-2 top-0 pt-3 sm:pt-0   sm:w-9 sm:h-9 rounded-full object-cover"
    />
  </div>
);
...
const AssetIcon = () => (
  <img
    ...
    alt="Assets"
    className="w-4 h-3 sm:w-6 sm:h-6"
  />
);

const FolderIcon = () => (
  <img src={foldersLogo} alt="Folders" className="w-2 h-3 sm:w-6 sm:h-6" />
);
